...
<div className="dropdown">
  ...
  <a onClick={add_users}  className="dropdown-item"><strong>Добавить пользователя</strong></a> 
  {error && <h1>{error}</h1>}
                {sort.map((sort) => (
                    ...
                    <a key={sort.id} 
                      ...
                      <span onClick={userpassword} title={`Сменить текущий пароль ${sort.password}`} slot={`${sort.id}`} className="redC">&nbsp;&nbsp;   &#128274;</span> 
                    </a>
